...
$switch = new Swith([
    "name" => "ativo",
    "descricao" => "Habilite o login e cadastro social usando a Amazon",
    "titulo" => "Logar com a Amazon",
]);
echo $switch->html();
...
$input->set("descricao", "Obtido ao registrar seu aplicativo na Amazon Developer.");
echo $input->html();
