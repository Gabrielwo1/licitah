...
$switch = new Swith([
    "name" => "ativo",
    "descricao" => "Habilite o login e cadastro social usando o GitHub",
    "titulo" => "Logar com o GitHub",
]);
echo $switch->html();
...
$input->set("descricao", "Obtido ao registrar seu aplicativo no GitHub Developer.");
echo $input->html();
