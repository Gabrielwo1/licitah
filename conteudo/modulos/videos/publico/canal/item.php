<div class="card-body overflow-y-auto overflow-x-hidden" id="conteudo">
   <style> 
   .header-grupo {
    border-radius: 20px;
      ...
      <div class="container-fluid">
         <div class="container">
            <div class="header-grupo">
               <div class="header-grupo-capa"> <img loading="lazy" src="https://fortram.site/placeholder/1300x400" class="grupo-capa"> </div>
               <div class="header-grupo-info">
                  <div class="row align-items-center">
                     <div class="col-lg-6">
                        <div class="grupo-header-nome">
                           <div class="grupo-avatar grupo-avatar"> <img loading="lazy" src="https://fortram.site/placeholder/200x200"> </div>
                           <div class="grupo-nome">
                              <h3>Grupo onde fingimos ser crentes</h3>
                        ...
                        <div class="grupo-header-dados">
                           ...
                           <div class="grupo-dados-box">
                              <div class="grupo-acoes">
                                 <button class="btn btn-nown-style btn-n-primaria"><i class="icon-btn-nown bi bi-person-add"></i><span>Inscreva-se</span></button> 
                              </div>
                           </div>
                        </div>
                     </div>
               ...
               <div class="col-lg-12">
                  <div class="card card-nown card-grupo-nav">
                      <div class="grupo-main-nav">
                          <button href="/home" class="grupo-nav-item active btn">
                              <div>
                                  <div><i class="bi bi-layout-text-sidebar"></i> </div>
                                  <div class="text-center fs-14 mt-2">Inicio</div>
                              </div>
                          </button> 
                          <button href="/home" class="grupo-nav-item btn"> 
                          <div>
                                  <div><i class="bi bi-play-btn"></i> </div>
                                  <div class="text-center fs-14 mt-2">Vídeos</div>
                              </div>
                     </button> 
                          <button href="/home" class="grupo-nav-item btn"> 
                          <div>
                                  <div><i class="bi bi-camera-reels"></i></div>
                                  <div class="text-center fs-14 mt-2">Shorts</div>
                              </div>
                          </button> 
                          <button href="/home" class="grupo-nav-item btn"> 
                           <div>
                                  <div><i class="bi bi-mic"></i></div>
                                  <div class="text-center fs-14 mt-2">Podcasts</div>
                              </div>
                          ...
                          <button href="/home" class="grupo-nav-item btn"> 
                              <div>
                                  ...
                                  <div class="text-center fs-14 mt-2">Playlists</div>
                              </div>
