...
(function e(t, i) {
    ...
    var n = t.defaults = {
        ...
        pdfjsSrc: "https://cdn.jsdelivr.net/npm/@dearhive/dearflip-jquery-flipbook@1.7.3/dflip/js/libs/pdf.min.js",
        pdfjsCompatibilitySrc: "https://cdn.jsdelivr.net/npm/@dearhive/dearflip-jquery-flipbook@1.7.3/dflip/js/libs/compatibility.js",
        pdfjsWorkerSrc: "https://cdn.jsdelivr.net/npm/@dearhive/dearflip-jquery-flipbook@1.7.3/dflip/js/libs/pdf.worker.min.js",
        threejsSrc: "https://cdn.jsdelivr.net/npm/@dearhive/dearflip-jquery-flipbook@1.7.3/dflip/js/libs/three.min.js",
        mockupjsSrc: "https://cdn.jsdelivr.net/npm/@dearhive/dearflip-jquery-flipbook@1.7.3/dflip/js/libs/mockup.min.js",
        soundFile: "https://cdn.jsdelivr.net/npm/@dearhive/dearflip-jquery-flipbook@1.7.3/dflip/sound/turn2.mp3",
        imagesLocation: "https://cdn.jsdelivr.net/npm/@dearhive/dearflip-jquery-flipbook@1.7.3/dflip/images",
        imageResourcesPath: "https://cdn.jsdelivr.net/npm/@dearhive/dearflip-jquery-flipbook@1.7.3/dflip/images/pdfjs/",
        cMapUrl: "cmaps/",
    ...
    var V = function(e, n) {
        ...
        var d = function(e) {
            ...
            if (e > n.target.pageCount) e = n.target.pageCount;
            return e
        };
        ...
        function be(e) {
            ...
            case me:
                ...
                if (window.dfLightBox && window.dfActiveLightBoxBook) {
    ...
    function q() {
        G = function(e) {
            ...
            function t(t) {
                ...
                a.dispose = function() { - a.clearChild();
                    a.render();
    ...
    var Y = function(e) {
        ...
        function a(e, a, o, r) {
            ...
            if (typeof s.contentSource == "string" || s.contentSource instanceof String) {
                var d = function() {
                ...
                if (window.pdfjsLib == null) {
                    if (s) {
                        ...
                        M(n.pdfjsSrc + "?ver=" + t.version, function() {
                            ...
                            if (typeof exports === "object" && exports["pdfjs-dist/build/pdf"] != null) {
                ...
                if (e.activeThumb != e.targetObject._activePage) {
                    ...
                    if (o) {
                        ...
                        if (u.length > 0) {
                            ...
                            if (s > u.offsetTop) l.scrollIntoView(u);
        ...
        a.prototype.getPage = function(e, a, o) {
            ...
            if (e <= 0 && e >= r.pageCount) {
                ...
                if (r.contentSourceType == c.IMAGE || r.contentSourceType == c.HTML) {
                    if (r.getCache(e, o) != null) {
                        r.setPage(e, r.getCache(e, o), a, o);
                        k("Page " + e + " loaded from cache")
                    } else {
        ...
        a.prototype.setupAnnotations = function(e, a, o, r) {
            ...
            return e.getAnnotations().then(function(l) {
                ...
                if (s.options.pageSize == t.PAGE_SIZE.DOUBLEINTERNAL && r > 2 && r % 2 == 1) {} else
                if (r == 1) {}
                if (o == null) {
                    return
                }
                ...
                if (s.skipDrag !== true) {
                    ...
                    if (s.dragPage) {
                        ...
                        if (n.x == s.startPoint.x && n.y == s.startPoint.y && n.isInside == true) {
                            ...
                            if (s.corner == t.CORNERS.BL || s.corner == t.CORNERS.TL) {
                                c(n);
            ...
            p = function(e) {
                ...
                if (s.skipDrag !== true) {
                    if (i.isInside == true && !r(s)) {
                        ...
                        if (i.page.name == Math.ceil(s.pageCount / 2) - 1) {
                            s.shadow.css({
                                width: "50%",
            ...
            if (t.indexOf("=") >= 0) {
                ...
                if ("zoom" in  i) {
                    ...
                    if (r.indexOf("Fit") === -1) {
                        ...
                        if (r === "FitH" || r === "FitBH" || (r === "FitV" || r === "FitBV")) {
                            a = [null, {
                                name: r
                            },
...
(function(e) {
    ...
    e(document).ready(function() {
        ...
        if (typeof dFlipLocation !== "undefined") {
            ...
            DFLIP.defaults.mockupjsSrc = "https://cdn.jsdelivr.net/npm/@dearhive/dearflip-jquery-flipbook@1.7.3/dflip/js/libs/mockup.min.js";
            DFLIP.defaults.pdfjsSrc = "https://cdn.jsdelivr.net/npm/@dearhive/dearflip-jquery-flipbook@1.7.3/dflip/js/libs/pdf.min.js";
            DFLIP.defaults.pdfjsCompatibilitySrc = "https://cdn.jsdelivr.net/npm/@dearhive/dearflip-jquery-flipbook@1.7.3/dflip/js/libs/compatibility.js";
            DFLIP.defaults.threejsSrc = "https://cdn.jsdelivr.net/npm/@dearhive/dearflip-jquery-flipbook@1.7.3/dflip/js/libs/three.min.js";
            DFLIP.defaults.pdfjsWorkerSrc = "https://cdn.jsdelivr.net/npm/@dearhive/dearflip-jquery-flipbook@1.7.3/dflip/js/libs/pdf.worker.min.js";
            DFLIP.defaults.soundFile = "https://cdn.jsdelivr.net/npm/@dearhive/dearflip-jquery-flipbook@1.7.3/dflip/sound/turn2.mp3";
            DFLIP.defaults.imagesLocation = "https://cdn.jsdelivr.net/npm/@dearhive/dearflip-jquery-flipbook@1.7.3/dflip/images";
            DFLIP.defaults.imageResourcesPath = "https://cdn.jsdelivr.net/npm/@dearhive/dearflip-jquery-flipbook@1.7.3/dflip/images/pdfjs/";
            DFLIP.defaults.cMapUrl = "https://cdn.jsdelivr.net/npm/@dearhive/dearflip-jquery-flipbook@1.7.3/dflip/js/libs/cmaps/";
